...
def initRoutes():
    ...
    r.root(controller='ezst', action='list')
    r.connect('/:action', controller='ezst')
    r.connect('/:action/:uid', controller='ezst')
    r.connect('/:action/:uid/:ip', controller='ezst')
    r.connect('/:action/:uid/:ip/:port', controller='ezst')
